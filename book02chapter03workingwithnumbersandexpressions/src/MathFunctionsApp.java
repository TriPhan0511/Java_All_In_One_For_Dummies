...
//		System.out.println("cbrt(x) = " + Math.cbrt(x)); // 2.9240177
//		System.out.println("exp(y) = " + Math.exp(y)); // 20.0855
//		System.out.println("hypot(y,z) = " + Math.hypot(y, x)); // 25.179
//		System.out.println("log(y) = " + Math.log(y)); // 1.098
//		System.out.println("log10(y) = " + Math.log10(y)); // 0.477121
...
//		System.out.println("random() = " + Math.random()); // 0.565
